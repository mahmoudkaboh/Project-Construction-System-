...
namespace ConstructionSystem.Controllers
{
    ...
    public class DepartmentsController : Controller
    {
        ...
        {
            //ViewBag.NumOfEmps = db.Employees.GroupBy(x => x.DepartmentID).Count();


            //var objDept = db.Departments.GroupBy(x=>x.DepartmentID).Select(x=>new { });

            //var tmp = from x in db.Employees
